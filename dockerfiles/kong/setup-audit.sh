...
curl -X POST http://localhost:8001/services \
  ...
  -d '{"name": "audit-service-v1", "host": "host.docker.internal", "port": 3003, "path": "/api/v1/audit"}'

curl -X POST http://localhost:8001/services \
  -H "Content-Type: application/json" \
  -d '{"name": "audit-service-v2", "host": "host.docker.internal", "port": 3003, "path": "/api/v2/audit"}'

curl -X POST http://localhost:8001/services \
  -H "Content-Type: application/json" \
  -d '{"name": "audit-public", "host": "host.docker.internal", "port": 3003, "path": "/api/audit/public"}'

curl -X POST http://localhost:8001/services \
  -H "Content-Type: application/json" \
  -d '{"name": "audit-openapi", "host": "host.docker.internal", "port": 3003, "path": "/api/audit"}'
